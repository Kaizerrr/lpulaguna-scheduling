                ...
                <div class="box-body">
                  ...
                  <div id="form">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <table style="font-style: italic;">
                          ...
                          <tr>
                            <td><b>3</b> Recommending Approval <b>(Registrar)</b></td>
                          </tr>
                          <tr>
                            <td><b>4</b> Approved <b>(School President)</b></td>
                          </tr>
                        </table>
                        <hr>
                    ...
                    <div class="form-group">
                      ...
                      <button class="btn btn-lg btn-primary" id="daterange-btn" style="background-color:#a62d38; border: 1px solid black" name="save" type="submit">
                        Send
                      </button>
                      <button class="btn btn-lg" id="daterange-btn" type="reset" style="background-color:white; color:black; border: 1px solid  black;">
                        Cancel
                      </button>
