                 ...
                 <div class="box-body">
                   ...
                   <div id="form">
                     ...
                     <div class="form-group">
                       ...
                       <button class="btn btn-lg btn-block" id="daterange-btn" name="save" type="submit" style="background-color:#a62d38; color:white; border: 1px solid  black;">
                         Save
                       </button>
                       <button class="btn btn-lg btn-block" id="daterange-btn" type="reset" style="background-color:white; color:black; border: 1px solid  black;">
                         Cancel
                       </button>
                 ...
                 <div class="box-body" style="" id="displayform">
                   ...
                   <div id="form">
                     ...
                     <div class="form-group">
                       ...
                       <button class="btn btn-lg btn-block btn-primary" style="background-color:#a62d38; border: 1px solid black;" id="daterange-btn" name="save" type="submit">
                         Update
                       </button>
