    ...
    <div class="content-wrapper">
      <div class="container">
        ...
        <section class="content-header">
          <h1>
            <a class="btn btn-lg" style="background-color:#a62d38; color:white; border: 1px solid black" href="home.php">Back</a>
                  ...
                  <form method="post" action="profile_update.php">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <button class="btn btn-primary" style="background-color:#a62d38; border: 1px solid  black" id="daterange-btn" name="">
                          Save
                        </button>
                        <button class="btn" id="daterange-btn" style="background-color:white; color:black; border: 1px solid  black; margin-left: 10px;">
                          Clear
                        </button>
                      </div>
                    </div><!-- /.form group -->
