							...
							<div class="box box-warning">
								<div style="text-align: center">
									<h4>Print Class Schedule
										<a href="#searcht" data-target="#searcht" data-toggle="modal" style="background-color:#a62d38;" class="dropdown-toggle btn btn-primary">

											Teacher
										</a>
										<a href="#searchclass" data-target="#searchclass" data-toggle="modal" style="background-color:#a62d38;" class="dropdown-toggle btn btn-success">

											Class
										</a>
										<a href="#searchroom" data-target="#searchroom" data-toggle="modal" style="background-color:#a62d38;" class="dropdown-toggle btn btn-primary">
												...
												<table class="table table-bordered table-striped" style="margin-right:-10px">
													...
													?>
														<tr>
															...
															<td><input type="checkbox" name="m[]" value="<?php echo $id; ?>" style="width: 20px; height: 20px;" <?php if (($id == $time_id) and ($day == 'm')) echo "checked"; ?>>
															</td>
															<td><input type="checkbox" name="th[]" value="<?php echo $id; ?>" style="width: 20px; height: 20px;" <?php if (($id == $time_id) and ($day == 'th')) echo "checked"; ?>></td>
											...
											<div class="col-md-4">
												<table class="table table-bordered table-striped">
													...
													?>
														<tr>
															<td><?php echo $start . "-" . $end; ?></td>
															<td><input type="checkbox" name="t[]" value="<?php echo $id; ?>" style="width: 20px; height: 20px;" <?php if (($id == $time_id) and ($day == 't')) echo "checked"; ?>></td>
															<td><input type="checkbox" name="f[]" value="<?php echo $id; ?>" style="width: 20px; height: 20px;" <?php if (($id == $time_id) and ($day == 'f')) echo "checked"; ?>></td>
											...
											<div class="col-md-4">
												<table class="table table-bordered table-striped">
													...
													?>
														<tr>
															<td><?php echo $start . "-" . $end; ?></td>
															<td><input type="checkbox" name="w[]" value="<?php echo $id; ?>" style="width: 20px; height: 20px;" <?php if (($id == $time_id) and ($day == 'w')) echo "checked"; ?>></td>
															<td><input type="checkbox" name="s[]" value="<?php echo $id; ?>" style="width: 20px; height: 20px;" <?php if (($id == $time_id) and ($day == 's')) echo "checked"; ?>></td>
								...
								<div class="box-body">
									...
									<div id="form">
										...
										<div class="form-group">
											...
											<button class="btn btn-lg btn-block btn-primary" id="daterange-btn" name="save" style="background-color:#a62d38" type="submit">
												Save
											</button>
									...
									<hr>
									</form> <button class="uncheck btn btn-lg btn-block btn-success" style="background-color:#a62d38">Uncheck All</button>
